...
class FirebaseRepositoryImpl implements FirebaseRepository {
  ...
  @override
  Future<String> upLoadPdfToFirebase(PlatformFile? platformFile, bool isPost, String childName) async =>
    remoteDataSource.upLoadPdfToFirebase(platformFile, isPost, childName);
  ...
  @override
  Future<void> readingOrNot(PostEntity post, UserEntity user) async => remoteDataSource.readingOrNot(post, user);
