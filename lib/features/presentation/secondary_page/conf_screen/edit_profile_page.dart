        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              sizeVer(15),
              ProfileFormWidget(title: "Nome", controller: _nameController),
              sizeVer(15),
              ProfileFormWidget(title: "Usuario", controller: _usernameController),
              sizeVer(15),
              ...
              _isUpdating == true?Row(
                ...
                children: [
                  const Text("Aguarde", style: TextStyle(color: Colors.white),),
                  sizeHor(10),
