                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text("${widget.replay.username}", style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: primaryColor),),
                        GestureDetector(
                    ...
                    sizeVer(4),
                    Text("${widget.replay.description}", style: const TextStyle(color: primaryColor),),
                    sizeVer(4),
                    Text(
