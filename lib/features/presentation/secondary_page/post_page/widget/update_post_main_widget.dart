      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(onTap: _updatePost,child: const Icon(Icons.done, color: blueColor, size: 28,)),
          )
        ],
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              sizeVer(10),
              Text("${widget.post.username}", style: const TextStyle(color: primaryColor, fontSize: 16, fontWeight: FontWeight.bold),),
              sizeVer(10),
              Stack(
                children: [
                  SizedBox(
