...
import 'package:bookgram/features/data/data_sources/remote_data_source/remote_data_source_impl.dart';
import 'package:bookgram/features/data/repository/firebase_repository_impl.dart';
import 'package:bookgram/features/domain/repository/firebase_repository.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/comment/create_comment_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/comment/delete_comment_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/comment/like_comment_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/comment/read_comment_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/comment/update_comment_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/post/create_post_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/post/delete_post_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/post/like_post_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/post/read_posts_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/post/read_single_post_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/post/update_post_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/replay/create_replay_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/replay/delete_replay_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/replay/like_replay_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/replay/read_replays_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/replay/update_replay_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/storage/upload_image_to_storage_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/user/create_user_usecase.dart';
...
import 'package:bookgram/features/domain/usecases/firebase_usecases/user/get_single_other_user_usecase.dart';
...
import 'package:bookgram/features/domain/usecases/firebase_usecases/user/is_sign_in_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/user/sign_in_user_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/user/sign_out_usecase.dart';
import 'package:bookgram/features/domain/usecases/firebase_usecases/user/sign_up_user_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory(
        () => UserCubit(
          ...
          followUnFollowUseCase: sl.call(), readingOrNotUserCase: sl.call()
    ),
  );
  ...
  sl.registerLazySingleton(() => ReadingOrNotUserCase(repository: sl.call()));
  ...
  sl.registerLazySingleton(() => UploadPdfToFirebase(repository: sl.call()));
